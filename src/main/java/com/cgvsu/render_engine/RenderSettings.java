 ...
 * 
 * <p>Реализует задание для третьего человека: "Режимы отрисовки".
 * Поддерживает переключение между режимами через галочки:
 * <ul>
 *   <li>Рисовать полигональную сетку (wireframe) - обводка полигонов</li>
 *   <li>Использовать текстуру - наложение текстуры вместо статического цвета</li>
 *   <li>Использовать освещение - простейшая модель освещения (пока не реализовано)</li>
 * </ul>
 * 
 * <p>Содержит параметры отображения:
 * <ul>
 *   <li>Режимы отрисовки (wireframe/filled)</li>
 *   <li>Цвета для заливки и обводки (статический цвет, если текстура не используется)</li>
 *   <li>Настройки Z-buffer для правильной отрисовки глубины</li>
 *   <li>Настройки backface culling</li>
 *   <li>Поддержка текстур (текстура загружается через меню)</li>
 *   <li>Триангуляция и растеризация (включены по умолчанию)</li>
 * </ul>
 * 
 * <p>Если не выбрана ни одна галочка, модель окрашивается статическим цветом.
 * При добавлении текстуры цвет подменяется на значения пикселей из текстуры.
 * При добавлении wireframe рисуются контуры полигонов поверх заливки.
 * 
 * @author CGVSU Team
 * @version 1.0
 */
